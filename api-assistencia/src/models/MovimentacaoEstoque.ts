...
export type MovimentacaoEstoqueTipo = 'entrada' | 'saida_os' | 'saida_venda' | 'estorno_os' | 'estorno_venda' | 'ajuste_manual';
...
type MovimentacaoEstoqueCreationAttributes = Optional<MovimentacaoEstoqueAttributes, 'id' | 'orcamento_id' | 'venda_id' | 'venda_item_id' | 'observacao'>;
  ...
  implements MovimentacaoEstoqueAttributes
{
  ...
  declare venda_id: number | null;
  declare venda_item_id: number | null;
    ...
    MovimentacaoEstoque.init(
      {
        ...
        tipo: {
          type: DataTypes.ENUM('entrada', 'saida_os', 'saida_venda', 'estorno_os', 'estorno_venda', 'ajuste_manual'),
          allowNull: false
        },
        quantidade: {
          type: DataTypes.INTEGER.UNSIGNED,
